...
const Students = () => {
	...
	const handleFilterStudents = useCallback(
		async (toSearch, genderValue, assignment) => {
			let newStudents = [];
			try {
				if (toSearch === '') {
					if (genderValue === 'genderAll') {
						if (assignment === 5) {
							...
							newStudents = dbStudents.filter(
								(student) => student.isBRead === true
							);
						} else if (assignment === 1) {
							newStudents = dbStudents.filter(
								(student) => student.isInitialCall === true
							);
						} else if (assignment === 2) {
							newStudents = dbStudents.filter(
								(student) => student.isReturnVisit === true
							);
						} else if (assignment === 3) {
							newStudents = dbStudents.filter(
								(student) => student.isBibleStudy === true
							);
						} else if (assignment === 4) {
							newStudents = dbStudents.filter(
								(student) => student.isTalk === true
							);
						}
					} else if (genderValue === 'isMale') {
						if (assignment === 5) {
							newStudents = dbStudents.filter(
								(student) => student.isMale === true
							);
						} else if (assignment === 0) {
							newStudents = dbStudents.filter(
								(student) => student.isMale === true && student.isBRead === true
							);
						} else if (assignment === 1) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isMale === true && student.isInitialCall === true
							);
						} else if (assignment === 2) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isMale === true && student.isReturnVisit === true
							);
						} else if (assignment === 3) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isMale === true && student.isBibleStudy === true
							);
						} else if (assignment === 4) {
							newStudents = dbStudents.filter(
								(student) => student.isMale === true && student.isTalk === true
							);
						}
					} else if (genderValue === 'isFemale') {
						if (assignment === 5) {
							newStudents = dbStudents.filter(
								(student) => student.isFemale === true
							);
						} else if (assignment === 0) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isFemale === true && student.isBRead === true
							);
						} else if (assignment === 1) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isFemale === true && student.isInitialCall === true
							);
						} else if (assignment === 2) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isFemale === true && student.isReturnVisit === true
							);
						} else if (assignment === 3) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isFemale === true && student.isBibleStudy === true
							);
						} else if (assignment === 4) {
							newStudents = dbStudents.filter(
								(student) =>
									student.isFemale === true && student.isTalk === true
							);
						}
					}
				} else {
					...
					if (genderValue === 'genderAll') {
						if (assignment === 5) {
							newStudents = dbStudents.filter((student) =>
								regex.test(student.person_name)
							);
						} else if (assignment === 0) {
							newStudents = dbStudents.filter(
								(student) =>
									regex.test(student.person_name) && student.isBRead === true
							);
						} else if (assignment === 1) {
							newStudents = dbStudents.filter(
								(student) =>
									regex.test(student.person_name) &&
									student.isInitialCall === true
							);
						} else if (assignment === 2) {
							newStudents = dbStudents.filter(
								(student) =>
									regex.test(student.person_name) &&
									student.isReturnVisit === true
							);
						} else if (assignment === 3) {
							newStudents = dbStudents.filter(
								(student) =>
									regex.test(student.person_name) &&
									student.isBibleStudy === true
							);
						} else if (assignment === 4) {
							newStudents = dbStudents.filter(
								(student) =>
									regex.test(student.person_name) && student.isTalk === true
							);
						}
					} else if (genderValue === 'isMale') {
						if (assignment === 5) {
							newStudents = dbStudents.filter(
								(student) =>
									regex.test(student.person_name) && student.isMale === true
							);
						} else if (assignment === 0) {
							newStudents = dbStudents.filter(
								(student) =>
						...
						if (assignment === 5) {
							newStudents = dbStudents.filter(
								(student) =>
									regex.test(student.person_name) && student.isFemale === true
							);
						} else if (assignment === 0) {
							newStudents = dbStudents.filter(
								(student) =>
	...
	const exportList = async () => {
		...
		for (let i = 0; i < students.length; i++) {
			...
			if (item.lastAssignment !== undefined && item.lastAssignment) {
				studentData.lastAssignment = dateFormat(
					item.lastAssignment,
					t('global.yes')
				);
			}
